...
// import {getRelationVoteEvent} from './vote-contract'

// export const getVotes = async (voteAddress:string, provider: BaseProvider) => {
// 	const voteAllLogs = getRelationVoteEvent(voteAddress, provider)
